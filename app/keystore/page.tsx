      ...
      <div className="border rounded-lg p-6" style={{ backgroundColor: 'hsl(0, 0%, 100%)', borderColor: 'hsl(0, 0%, 85%)' }}>
        ...
        {apiKeys.length === 0 ? (
          <div className="text-center py-12" style={{ color: 'hsl(330, 3%, 49%)' }}>
            ...
            <p className="font-medium mb-2" style={{ color: 'hsl(330, 3%, 19%)' }}>No API keys stored yet</p>
            <p className="text-sm mb-4">Add your first API key to get started with evaluations</p>
            <button
              onClick={onAddNew}
...
function AddKeyModal({
  ...
  return (
    ...
    >
      <div
        className="border rounded-lg shadow-lg max-w-lg w-full max-h-[90vh] overflow-y-auto"
